...
Coming to this field, we might notice that not all things are clearly defined and given a name. Even if some are given a name, there might exist some two of the terminologies pointing to one thing (or two things with trivial difference.) 
